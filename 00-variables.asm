...
k_serbuf_write: equ 0x0404      ; location of serial buffer write pointer
k_serbuf_read: equ 0x0405       ; location of serial buffer read pointer
k_serbuf_base: equ 0x0406       ; base of the serial buffer
