...
k_init_stdq:
    ...
    ld hl, 0x0000               ; prepare to populate kfn_addr
    ld (kfn_addr), hl           ; save it
    ld a, 0x00                  ; prepare to get address for slot 0 in function table
    push af                     ; prepare args
    call kfn_addr_by_idx        ; calculate address into hl
    ex de, hl                   ; swap so the location is the destination in de
    ld hl, kfn_sp               ; set source to the start of the record
    ldi                         ; kfn_sp high byte
    ldi                         ; kfn_sp low byte
    ldi                         ; kfn_addr high byte
    ldi                         ; kfn_addr low byte
